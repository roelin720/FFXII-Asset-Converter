...
void Phyre::PathHistory::save()
{
	...
	{
		std::cerr << "Failed to save input history " << std::string(e.what());
	}
}

int Phyre::PathHistory::find(const std::string& path, PathID pathID)
{
...
void Phyre::PathHistory::push(const std::string& path, PathID pathID)
{
...
std::string Phyre::PathHistory::last(PathID pathID)
{
...
void Phyre::PathHistory::load()
{
	...
	{
		std::cerr << "Failed to load input data " << std::string(e.what()) << std::endl;
	}
}
int Phyre::PathHistory::scroll_callback(ImGuiInputTextCallbackData* _data, PathID pathID)
{
	if (data[pathID].size())
	{
